...
{
    public partial class productsearchresults : Form
    {
        ...
        string searcher;
        string Key;
        public productsearchresults(string searchers, string key)
        {
            InitializeComponent();
            searcher = searchers;
            Key = key;
        ...
        public void datashow()
        {
            ...
            while (dr.Read())
            {
                  ...
                  productsearchdata.Rows.Insert(i, dr.GetInt32(0).ToString(), dr.GetString(3), dr.GetString(4), dr.GetString(1), dr.GetString(2));
                  i++;
